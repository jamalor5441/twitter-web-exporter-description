...
(function (preact, hooks, signals, i18next, dayjs, Dexie, dexieExportImport, tableCore) {
  ...
  const DEFAULT_FILENAME_PATTERN = "{screen_name}-{id}-{date}-{time}-【{name}】-{type}-{num}-{screen_description}.{ext}";
  ...
  const columns$2 = [
    ...
    columnHelper$2.accessor("core.user_results.result.legacy.screen_name", {
    ...
    columnHelper$2.accessor("core.user_results.result.legacy.name", {
  ...
  const columns$1 = [
    ...
    columnHelper$1.accessor("legacy.screen_name", {
      meta: { exportKey: "screen_name", exportHeader: "Screen Name" },
      header: () => /* @__PURE__ */ u(Trans, { i18nKey: "Screen Name" }),
    ...
    columnHelper$1.accessor("legacy.name", {
      meta: { exportKey: "name", exportHeader: "Profile Name" },
      header: () => /* @__PURE__ */ u(Trans, { i18nKey: "Profile Name" }),
      cell: (info) => /* @__PURE__ */ u("p", { class: "w-32", children: info.getValue() })
    }),
